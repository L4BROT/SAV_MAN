...
?>
    <table id="detail_SAV" class="table table-dark table-striped table-bordered">
        ...
        <tbody>
            <tr>
                <td><?php echo $detail_retour["ID_RETOUR"]; ?></td>
                <td><?php echo $detail_retour["QTE_RETOUR"]; ?></td>
                <td><?php echo $detail_retour["MOTIF_RETOUR"]; ?></td>
                <td><?php echo $detail_retour["ID_ARTICLE"]; ?></td>
                <td><?php echo $detail_retour["ID_TICKET"]; ?></td>
            </tr>
        </tbody>
    </table>
<?php
